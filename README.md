...
BOT_TOKEN=712345678:AAH_ExampleToken  # Токен от @BotFather



# === Database Settings ===

DB_USER=banan              # Логин к вашей БД PostgreSQL

DB_PASSWORD=12345678            # Пароль к вашей БД

DB_HOST=localhost            # Адрес сервера (обычно localhost)

DB_PORT=5432                 # Порт (по умолчанию 5432)

DB_NAME=banan_db           # Имя созданной базы данных
